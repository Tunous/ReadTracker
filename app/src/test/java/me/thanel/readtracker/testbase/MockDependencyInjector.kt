...
class MockDependencyInjector : RootComponent {
    ...
    override fun inject(progressSynchronizationService: ProgressSynchronizationService) {
        progressSynchronizationService.readingProgressRepository = readingProgressRepositoryMock
    }
}
